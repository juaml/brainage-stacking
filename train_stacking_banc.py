...
class StackingTrainer:
    ...
    def prepare_data(self):
        ...
        try:
            ...
            # Filter to training subjects
            if self.training_csv:
                ...
                mask = self.data["subject_id"].isin(train_ids)
                self.data = self.data[mask].reset_index(drop=True)
                self.logger.info(f"✓ Training subjects: {len(self.data)}")
    ...
    def train(self, model):
        ...
        try:
            ...
            with parallel_config(
                ...
                shared_data_dir="/data/group/appliedml/fkarateke_joblib_htcondor",
                log_dir_prefix="/data/group/appliedml/fkarateke_data/logs",
